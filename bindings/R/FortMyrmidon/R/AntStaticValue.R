...
#' @return a \code{\link{fmAntStaticValue}} of type \code{BOOL}, see \code{\link{fmAntMetadataType}}
NULL

#' @name fmAntStaticInteger
#' @title creates a \code{\link{fmAntStaticValue}} from an integer
#' @param v the integer to represent
#' @return a \code{\link{fmAntStaticValue}} of type \code{INTEGER}, see \code{\link{fmAntMetadataType}}
NULL

#' @name fmAntStaticNumeric
#' @title creates a \code{\link{fmAntStaticValue}} from a numerical value
#' @param v the numeric to represent
#' @return a \code{\link{fmAntStaticValue}} of type \code{DOUBLE}, see \code{\link{fmAntMetadataType}}
NULL

#' @name fmAntStaticString
#' @title creates a \code{\link{fmAntStaticValue}} from a character vector
#' @param v the character vector to represent
#' @return a \code{\link{fmAntStaticValue}} of type \code{STRING}, see \code{\link{fmAntMetadataType}}
NULL

#' @name fmAntStaticTime
#' @title creates a \code{\link{fmAntStaticValue}} from a \code{\link{fmTime}}
#' @param v the \code{\link{fmTime}} to represent
#' @return a \code{\link{fmAntStaticValue}} of type \code{TIME}, see \code{\link{fmAntMetadataType}}
NULL
